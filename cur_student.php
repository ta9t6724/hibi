    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-10 main-content">
          <div class="row"></div>
          <h1 class="h1 hibi_title" style="text-align: center;">在校生の日々をのぞいてみよう</h1>
          <div class="row">
            <?php foreach ($cur_students as $cur_student) { ?>
              <div class="col-md-3">
                <a href="my_page.php?user_id=<?php echo $cur_student["user_id"]; ?>"><img src="assets/img/<?php echo $cur_student["picture"]; ?>" class="hibi_pic" style="width: 250px; height: auto; margin: 60px 0 20px 0;"></a>
                <p style="text-align: center;"><?php echo $cur_student["account_name"]; ?></p>
              </div>
            <?php } ?>
          </div>
          <div aria-label="Page navigation">
            <ul class="pager">
              ...
              <?php }else{ ?>
              <li class="previous"><a href="cur_student.php?page=<?php echo $page-1; ?>"><span aria-hidden="true">&larr;</span>前へ</a></li>
              <?php } ?>

              <?php if ($page == $all_page_number){ ?>
                <li class="next disabled"><a href="#">次へ<span aria-hidden="true">&rarr;</span></a></li>
              <?php }else{ ?>
                <li class="next"><a href="cur_student.php?page=<?php echo $page+1; ?>">次へ<span aria-hidden="true">&rarr;</span></a></li>
              <?php } ?>
            </ul>
          </div>
        </div>
